...
public:
	...
	friend A3DVECTOR3 operator * (const A3DVECTOR3& v, int32_t f) { return v * (float)f; }
	friend A3DVECTOR3 operator * (int32_t f, const A3DVECTOR3& v) { return v * (float)f; }
	friend A3DVECTOR3 operator * (const A3DVECTOR3& v1, const A3DVECTOR3& v2) { return A3DVECTOR3(v1.x * v2.x, v1.y * v2.y, v1.z * v2.z); }
	...
	//	Dot product
	float DotProduct(const A3DVECTOR3& v1, const A3DVECTOR3& v2) { return v1.x * v2.x + v1.y * v2.y + v1.z * v2.z; }
