...
#define A3DCOLOR_GETRED(color) ((uint8_t)(((color) & 0x00ff0000) >> 16))
#define A3DCOLOR_GETGREEN(color) ((uint8_t)(((color) & 0x0000ff00) >> 8))
#define A3DCOLOR_GETBLUE(color) ((uint8_t)(((color) & 0x000000ff)))
#define A3DCOLOR_GETALPHA(color) ((uint8_t)(((color) & 0xff000000) >> 24))
